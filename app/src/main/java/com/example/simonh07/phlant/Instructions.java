...
public class Instructions extends AppCompatActivity {
    ...
    String text[] = {"Facebook Account is needed for access in the application PHLANT."
            ...
            , "When a plant that is displayed is clicked, it will prompt a share dialog of the link that relates to how to take care of the clicked plant."
    ...
    int icons[]= {R.drawable.login,R.drawable.facebooklogin,R.drawable.confirmation,R.drawable.weather,R.drawable.weatherbutton,
            R.drawable.lobby,R.drawable.clickonlobby,R.drawable.navigationdraweer,R.drawable.chatbot};
    @Override
